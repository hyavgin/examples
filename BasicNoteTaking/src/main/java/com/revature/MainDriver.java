...
public class MainDriver {
	...
	public static void welcomeMessage(Scanner sc, AuthenticationService as) {
		System.out.println("Helo, Welcome to my Notetaking application!");
		System.out.println("First we must make sure you have access!");
		System.out.println("Put in user name");
	...
	public static void menuOptions() {
		...
		System.out.println("Would you like to write something new? [0]");
		System.out.println("Would you like to read your previous notes? [1]");
		System.out.println("Would you like to delete all notes? [2]");
	...
	public static void main(String[] args) {
		...
		FileService fs = new FileServiceImplFaster();
